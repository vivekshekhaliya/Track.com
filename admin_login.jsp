                    ...
                    <div class="col-lg-12 col-sm-6 mb-5" >
                        ...
                        <section class="vh-100" style="background-color:whitesmoke;font-size:22px">
                            <div class="container h-100">
                                <div class="row mb-5 d-flex justify-content-center align-items-center h-auto">
                                            ...
                                            <div class="card-body p-md-5">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                                        ...
                                                        <form class="mx-1 mb-5 mx-md-4" method="post" action="A_login">
                                                            ...
                                                            <div class="d-flex flex-row align-items-center mb-4">
                                                                ...
                                                                <div class="form-outline flex-fill mb-0"
                                                                    ...
                                                                    <input type="tel" name="mobile" id="form3Example3c"
                                                                        class="form-control" />
                                                                    <label class="form-label"
                                                                        for="form3Example3c">Mobile No</label>
                                                                </div>
                                                            </div>
...
<%
	if(session.getAttribute("sms3")!=null)
	{
		out.println("<h6><center><b style='color:red'>"+session.getAttribute("sms3")+"</b></center></h6>");
	}
%>
