        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)" style="color:blue">User Profile</a></li>
...
<%
		...
		try
		{
			...
			String q="select * from user where user_removed='no' ";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                 <%   out.println("<img class='mr-3' src='uplod_images/"+r.getString(6)+"' width='80' height='80' alt='User image'>");%> 
                                ...
                                <div class="col-12 text-center">
                                  <%   out.println("<a href='A_Delete_user?mobile_no="+r.getString(3)+"' class='btn btn-danger px-5'>Remove</a>"); %>
                                </div>
                            </div>
                        </div>
                    </div>
