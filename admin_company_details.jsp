        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)" style="color:blue">Company Details</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12 text-center">
                                   <%  out.println("<a  href='A_Delete_company?company_id="+r.getString(1)+"&company="+r.getString(2)+"' class='btn btn-danger px-5'>Close Deal</a>");%>
                                </div>
                            </div>
                        </div>
                    </div>
