                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mr-3 mt-4">  <% out.println("<img src='uplod_images/"+img+"' height='40' width='40' style='border-radius:50%'>");%>
                          <b >Edit Profile</b></p>
...
%>
                                        ...
                                        <form enctype="multipart/form-data" class="mx-1 mx-md-4" method="post" action="edit_profile">

                                            <div class="d-flex flex-row align-items-center mb-4">
                                                <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text"  value="<%=r.getString(1) %>" id="form3Example1c" name="name"
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text"  value="<%=r.getString(2) %>" required name="email" id="form3Example3c"
                                                        class="form-control" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="tel"  value="<%=r.getString(3) %>" required name="mobile" id="form3Example3c"
                                                        class="form-control"  />
                                                    ...
                                                    <input type="hidden"  value="<%=r.getString(3) %>"  name="mobile_no" id="form3Example3c"
                                                        class="form-control"  />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <%
													...
													%>
                                                        ...
                                                        <label class="radio-inline mr-3">
                                                            <input type="radio" checked value="Female" name="gender">Female</label>
											 ...
											 <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <textarea name="about" id="form3Example4cd"
                                                        class="form-control" required> <%=r.getString(8) %></textarea>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text" name="pwd" id="form3Example4c"
                                                        class="form-control"  value="<%=r.getString(7) %>"  required/>
                                            ...
                                            <div>
                                                ...
                                                <span class="ml-4"> I agree all statements in <a class=""
                                                        style="color:lightblue" href="#!">Terms of service</a>
                                                </span>
                                            </div>
...
<%
	...
	if(session.getAttribute("sms7")!=null) 
	{
		out.println("<h6><center><b style='color:red'>"+session.getAttribute("sms7")+"</b></h6></center>");
	}
