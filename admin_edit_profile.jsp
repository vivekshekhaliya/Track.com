...
%>
<%
	if(request.getParameter("mobile_no")!=null || session.getAttribute("sms6")!=null)
	{
...
%>
                                        ...
                                        <form enctype="multipart/form-data" class="mx-1 mx-md-4" method="post" action="A_editprofile">
...
<%
	...
	if(session.getAttribute("sms6")!=null) 
	{
		out.println("<h6><center><b style='color:red'>"+session.getAttribute("sms6")+"</b></h6></center>");
	}
