...
<%@page import="java.sql.*"  %>
                    ...
                    <div class="col-12 m-b-30 mb-2 mt-1">
                        <table border=0 style="width:100%;height:100%;">
                            <tr>
                                ...
                                <td>
                                    <div class="mb-5"
                                        style="padding-top:0px;padding-right:30px;padding-left:0px;padding-bottom:0px">
                                        <b style="font-size:20px"> Removed Bikes &nbsp</b>
                                        <br>
                                    </div>
 ...
 <%
	...
	try
	{
		...
		String q="select * from bikes where bike_remove='yes' ";
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex;flex-direction: column;align-items: left; justify-content: center;
                                          ...
                                          <% out.println("<a href='A_Restore_bike?bike_id="+r.getString(1)+"'  class='btn mb-1 btn-primary pl-5 pr-5' style='color:white'> Restore <span class='btn-icon-right'><i class='fa fa-edit'></i></span></a>");
