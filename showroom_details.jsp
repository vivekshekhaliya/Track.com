                    ...
                    <div class="col-xl-7 col-lg-16 col-sm-16 col-xxl-16 h-100">
                        <div class="card h-100">
                            <div class="card-body h-100">
                                ...
                                <!--Google map-->
                                <div id="map-container-google-2" class="z-depth-1-half map-container h-100 w-100">
                                   <%  out.println("<iframe src='https://maps.google.com/maps?q="+r.getString(4)+"&t=&z=13&ie=UTF8&iwloc=&output=embed ' class='w-100' style='height:150px' frameborder='0' border='0' allowfullscreen></iframe>");
                                   %>
                                   </div>
